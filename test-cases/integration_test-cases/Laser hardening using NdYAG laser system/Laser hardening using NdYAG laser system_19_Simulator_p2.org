...
* Test Steps
  ...
  4. Don't select the Type of State,Power and Spotsize from the dropdown list present at the corresponding field
...
* Expected result
  ...
  4. An error message should be displayed on the screen as to select theType of State,Power and Spotsize from the dropdown list present at the corresponding fields
