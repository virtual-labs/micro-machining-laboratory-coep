...
* Objective
  - To view the Experimental setup of  “To study influence of process parameters on the Wire EDM ” experiment
...
* Post conditions
  - Nil
* Test Steps
  1. Click on the Experimental setup link 
  2. It should re-direct to the Experimental setup page

* Expected result
  1. Experimental Setup page should be opened
